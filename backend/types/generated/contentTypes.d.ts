...
export interface ApiBoardDirectorBoardDirector
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    independent: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiDisclaimersDisclaimers extends Struct.SingleTypeSchema {
  collectionName: 'disclaimers';
  info: {
    description: 'Verbatim disclaimer paragraphs + effectiveDate (Legal Reviewer only)';
    displayName: 'Disclaimers';
    pluralName: 'disclaimers-plural';
    singularName: 'disclaimers';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiFundDocumentFundDocument
  extends Struct.CollectionTypeSchema {
...
export interface ApiLegalPageLegalPage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Privacy + Terms. Rich text body + effectiveDate (Legal Reviewer only)';
...
export interface ApiPortfolioSnapshotPortfolioSnapshot
  extends Struct.SingleTypeSchema {
...
export interface ApiSecFilingSecFiling extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    filedDate: Schema.Attribute.Date & Schema.Attribute.Required;
    formType: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::portfolio-snapshot.portfolio-snapshot': ApiPortfolioSnapshotPortfolioSnapshot;
